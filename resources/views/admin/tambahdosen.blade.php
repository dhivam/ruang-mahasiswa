...
<body>
    ...
    <div class="atas">
        <p><a style="color:skyblue; text-decoration:none;" href="/dosenadm">Daftar Dosen </a><span style="color: white;">/ Tambah Dosen</span></p>
    </div>
    <table style="width:800px;">
        ...
        <form action="/dosenadm/store" method="post">
            {{ csrf_field() }}
            ...
            <tr>
                ...
                <td>:</td>
                <td><input type="textarea" name="alamat" required="required"></td>
            </tr>
            <tr>
                <td>
