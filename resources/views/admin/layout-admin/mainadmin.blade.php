...
<head>
    ...
    <!-- Favicons -->
    <link href="img/logotopi.png" rel="icon">
...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center ">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="logo">
                <h1><a href="index.html">Ruang Mahasiswa - Admin</a></h1>
            </div>

            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="nav-link scrollto" href="/mahasiswa">Mahasiswa</a></li>
                    <li><a class="nav-link scrollto" href="/dosenadm">Dosen</a></li>
                    <li><a class="nav-link scrollto" href="/matkul">Matakuliah</a></li>
